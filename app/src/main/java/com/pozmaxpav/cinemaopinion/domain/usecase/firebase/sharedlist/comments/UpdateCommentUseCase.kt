...
class UpdateCommentUseCase @Inject constructor(
    ...
    suspend operator fun invoke(listId: String, movieId: Int, commentId: String, selectedComment: DomainCommentModel) {
        repository.updateComment(listId, movieId, commentId, selectedComment)
    }
}