...
sealed class Route(val route: String) {
    ...
    data object AchievementsScreen : Route(route = "achievements_screen?listAwards={listAwards}") {
        fun getListAwards(listAwards: String) = "achievements_screen?listAwards=$listAwards"
    }
